...
<head>
    ...
    #overlay {
        ...
        .photo1 { top: 41px; left: 38px; }
        .photo2 { top: 234px; left: 38px; }
        .photo3 { top: 427px; left: 38px; }
        .photo4 { top: 620px; left: 38px; }

        /* 복제된 사진의 위치 조정 */
        .photo1-duplicate { top: 41px; right: 36px; /* 오른쪽으로 30px 이동 */}
        .photo2-duplicate { top: 234px; right: 36px; }
        .photo3-duplicate { top: 427px; right: 36px; }
        .photo4-duplicate { top: 620px; right: 36px; }
    </style>
</head>
<body>
<div id="overlay"></div>
<div id="fullscreenGif"></div>
    ...
    <c:if test="${not empty imageBase64}">
        ...
        <img id="photoFrame" src="/images/photoframe_ff.png" alt="Photo Frame">
                    ...
                    if (loadedImages === selectedPhotos.length) {
                        setTimeout(() => {
                            html2canvas(document.getElementById("photoFrameContainer")).then(function(canvas) {
                                ...
                                xhr.open('POST', '/saveprintImageAndURL', true); // 수정된 엔드포인트
